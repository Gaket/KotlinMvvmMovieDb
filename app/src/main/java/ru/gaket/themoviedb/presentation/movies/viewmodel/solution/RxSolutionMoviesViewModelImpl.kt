package ru.gaket.themoviedb.presentation.movies.viewmodel.solution
...
internal class RxSolutionMoviesViewModelImpl(
    ...
    class Factory(
        ...
        override fun <T : ViewModel?> create(modelClass: Class<T>): T {
            return RxSolutionMoviesViewModelImpl(schedulerProvider, repo, navigator) as T
        }
    }
}
